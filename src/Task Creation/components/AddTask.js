    ...
    return (
        <div className="add-task">
            <header className="app-header">
                <span className='app-label'>New Task </span>
            </header>
            ...
            <div className="add-task-container">
...

                {
                    (countTrueVal === 3) ? (<div
                        ...
                        onClick={() => {
                            taskCreation.taskCreationData.push({ taskDescription, selectedIcons, selectedTime, selectedFrequency, customTime, })
                            taskCreation.setTaskCreationData(taskCreation.taskCreationData);
                            navigate('/app/task-creation');
                        }}>
                        <span>CREATE TASK</span>
                    </div>) : (<div className="inactivecreate-task">
                        <span>CREATE TASK</span>
                    </div>)
                }
...
//[TaskCreationButton, addTaskcustomTimeValide, findTrueRecordFrequency, findTrueRecordIcon, findTrueRecordTime,findTrueRecordTaskDescription];

// let refTaskDescription = useRef(null);
// useEffect(() => {
//     if (!validateAddTaskData[5]) {
//         refTaskDescription.current.style.borderBottomColor = "red";
//     }
//     else {
//         refTaskDescription.current.style.borderBottomColor = "#4343A0";
//     }
// });